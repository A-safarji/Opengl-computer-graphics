...
Display()
{
  ...
  // gluLookAt(0, 20, 70, 0., 0., 0., 0., 10, 0.);
 ...
 glRotatef(rot, 0., 0., -60.);
  ...
  //glRotatef(20.0, 30, 40, -20.0);
   ...
   //  Draw();
    ...
    glLoadIdentity();
    glColor3f(1., 1., 1.);
    DoRasterString(5., 5., 0., "Best draw");
...
{
    float dist = vin[0]*vin[0] + vin[1]*vin[1] + vin[2]*vin[2]; if( dist > 0.0 )
    {
        dist = sqrt( dist );
        vout[0] = vin[0] / dist;
        vout[1] = vin[1] / dist;
